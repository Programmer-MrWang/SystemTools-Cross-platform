// 来源：SystemTools（主插件）Models\UI\IconExpressionEditorViewModel.cs → 抽取自 ClassIsland 主程序（LGPL-3.0-only，同许可）。
using System;
...
using SystemTools.CrossPlatform.Helpers.SimpleExpression;

namespace SystemTools.CrossPlatform.Models.UI;
